      ...
      <div className={`glass-card ${showSuccess ? 'success-glow' : ''}`}>
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className={`social-buttons form-element ${formFadeOut ? 'fade-out' : ''}`}>
            <button type="button" className="social-btn" onClick={() => window.location.href = `${API_URL}/auth/google`}>
            ...
            <button type="button" className="social-btn" onClick={() => window.location.href = `${API_URL}/auth/github`}>
